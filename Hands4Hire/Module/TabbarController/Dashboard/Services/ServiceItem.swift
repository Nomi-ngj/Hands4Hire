...
let allServices: [ServiceItem] = [
    ...
    ServiceItem(id: 6, title: "Cleaner", imageName: "cleaner_icon", type: .categories, description: "Hire a professional cleaner to keep your home spotless.", overview: "Comprehensive cleaning services tailored to your needs.", expectedDuration: "2-4 hours", costRange: "$100 - $500"),
